...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-white border border-gray-200 dark:border-transparent dark:dark:border-white/[0.2] group-hover:border-indigo-300 dark:group-hover:border-slate-700 relative z-20",
        className
      )}
    >
