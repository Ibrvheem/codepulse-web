...
export function ProjectCard({ item }: { item: ProjectItem }) {
  ...
  return (
    <div className=" cursor-pointer border border-gray-200 rounded-lg p-6 hover:border-gray-400 hover:shadow-sm transition-all bg-white">
      <div className="flex flex-col h-full">
        ...
        <div
          className=" group p-2 border-gray-100 rounded-md  hover:bg-blue-50 flex items-center justify-between text-sm ease-in-out transition-all"
